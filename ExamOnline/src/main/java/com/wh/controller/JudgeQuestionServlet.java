...
import com.wh.service.impl.IJudgeQuestionService;
 ...
 * @creat 2022--09-16:37
 */
@WebServlet("/judgeQuestion/*")
public class JudgeQuestionServlet extends BaseServlet{
    private JudgeQuestionService service = new IJudgeQuestionService();
    public void getQuestionList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //根据query获得列表数据和数量
        List<JudgeQuestion> list = service.getQuestionList(questionQuery);
    ...
    public void questionDetail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JudgeQuestion question = service.selectById(Integer.parseInt(id));
        ...
        response.sendRedirect(request.getContextPath() + "/templates/ques/editJudgeQuestion.jsp");
    }
    //修改
    public void editQuestion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JudgeQuestion question = JSON.parseObject(s, JudgeQuestion.class);
//        System.out.println(question);
    ...
    public void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.sendRedirect(request.getContextPath() + "/templates/ques/addJudgeQuestion.jsp");
    }
    //添加
    public void addQuestion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JudgeQuestion question = JSON.parseObject(text, JudgeQuestion.class);
