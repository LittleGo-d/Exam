...
<div class="div-content">
    ...
    <script inline="javascript">
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#table-user'
                ,url:  'http://localhost:8080<%=request.getContextPath()%>/user/getUserList' //数据接口
                ,page: true //开启分页
                ,toolbar: "#table-user-toolbar"//开启头部工具栏
                ,limits: [5,10,30,50,100]
                ,cols: [[ //表头
                    {type: "checkbox",width: 60}
                    ,{field: 'userId', title: '学号/学工号',width: 200,sort: true,align: 'center'}
                    ,{field: 'userName', title: '姓名',align: 'center'}
                    ,{field: 'sex', title: '性别', sort: true ,align: 'center'}
                    ,{field: 'profession', title: '专业',width: 200, sort: true ,align: 'center'}
