...
<body>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="optionA" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项A" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">选项B</label>
        <div class="layui-input-block">
            <input type="text" name="optionB" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项B" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">选项C</label>
        <div class="layui-input-block">
            <input type="text" name="optionC" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项C" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">选项D</label>
        <div class="layui-input-block">
            <input type="text" name="optionD" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项D" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <script>
        layui.use(['form','table'], function () {
            ...
            form.on('submit(formDemo)', function (data) {
                ...
                var url = "<%=request.getContextPath()%>/multiQuestion/addQuestion";
