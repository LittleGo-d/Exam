...
<%
    ...
    if(cookies != null){
        for(Cookie cookie : cookies){
            ...
            if(cookie.getName().equals("optionA")){
                optionA = cookie.getValue();
            }
            if(cookie.getName().equals("optionB")){
                optionB = cookie.getValue();
            }
            if(cookie.getName().equals("optionC")){
                optionC = cookie.getValue();
            }
            if(cookie.getName().equals("optionD")){
                optionD = cookie.getValue();
            }
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="optionA" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项A" value="<%=optionA%>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">选项B</label>
        <div class="layui-input-block">
            <input type="text" name="optionB" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项B" value="<%=URLDecoder.decode(optionB,"UTF-8")%>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">选项C</label>
        <div class="layui-input-block">
            <input type="text" name="optionC" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项C" value="<%=URLDecoder.decode(optionC,"UTF-8")%>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">选项D</label>
        <div class="layui-input-block">
            <input type="text" name="optionD" lay-verify="required" lay-reqtext="选项不能为空" placeholder="请输入选项D" value="<%=URLDecoder.decode(optionD,"UTF-8")%>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="answer" lay-verify="required">
                <option value="<%=URLDecoder.decode(answer,"UTF-8")%>"><%=URLDecoder.decode(answer,"UTF-8")%></option>
...
<script inline="javascript">
        layui.use(['form','table'], function() {
            ...
            form.on('submit(questionEdit-filter)', function(data){
                ...
                var url = "<%=request.getContextPath()%>/multiQuestion/editQuestion";
